...
/// @title  Speedtracer Onchain Dinos Theme
/// @notice Colors, font and names for Onchain Dinos themed Speedtracer track
contract DinoThemeRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0x99CCFF;
    uint24 public constant KERB_COLOR = 0xBF6157;
    uint24 public constant ROAD_COLOR = 0xDCDCDC;
    uint24 public constant MIDLINE_COLOR = 0xCCB144;
