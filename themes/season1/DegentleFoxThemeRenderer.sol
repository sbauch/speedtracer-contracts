...
contract DegentleFoxThemeRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0x90579B;
    uint24 public constant KERB_COLOR = 0x341948;
    uint24 public constant ROAD_COLOR = 0xB19FF9;
    uint24 public constant MIDLINE_COLOR = 0xFEA303;
