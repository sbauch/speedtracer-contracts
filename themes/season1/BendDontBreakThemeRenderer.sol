...
contract BendDontBreakThemeRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0xFFFFFF;
    uint24 public constant KERB_COLOR = 0x101010;
    uint24 public constant ROAD_COLOR = 0xFFFFFF;
    uint24 public constant MIDLINE_COLOR = 0x999999;
