...
contract MetropolitanoParasolThemeRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0xC6D2E2;
    uint24 public constant KERB_COLOR = 0xDB614A;
    uint24 public constant ROAD_COLOR = 0xE5C59F;
