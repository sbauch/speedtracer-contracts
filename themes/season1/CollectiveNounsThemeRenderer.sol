...
contract CollectiveNounsThemeRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0xF9E5A0;
    uint24 public constant KERB_COLOR = 0x000000;
    uint24 public constant ROAD_COLOR = 0x1652F0;
    uint24 public constant MIDLINE_COLOR = 0xF9E5A0;
