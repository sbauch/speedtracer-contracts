...
contract AshphaltThemeRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0xFFE901;
    uint24 public constant KERB_COLOR = 0xAF0C1A;
    uint24 public constant ROAD_COLOR = 0xFFAC01;
    uint24 public constant MIDLINE_COLOR = 0xFFE901;
