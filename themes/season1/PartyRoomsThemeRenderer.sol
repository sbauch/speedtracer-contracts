...
contract PartyRoomsThemeRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0x000000;
    uint24 public constant KERB_COLOR = 0x546378;
    uint24 public constant ROAD_COLOR = 0x02C1FA;
