...
/// @title  Speedtracer Bitcoin Pizza Theme
/// @notice Colors, font and names for Bitcoin Pizza themed Speedtracer track
contract BitcoinPizzaThemeRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0xFFAF00;
    uint24 public constant KERB_COLOR = 0xF06400;
    uint24 public constant ROAD_COLOR = 0xBF6157;
