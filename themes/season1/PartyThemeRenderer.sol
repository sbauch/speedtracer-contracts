...
/// @title  Speedtracer PartyDAO Theme
/// @notice Colors, font and names for PartyDAO themed Speedtracer tracks
contract PartyThemeRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0xE5EDF5;
    uint24 public constant KERB_COLOR = 0x06C1FA;
    uint24 public constant ROAD_COLOR = 0xffffff;
    uint24 public constant MIDLINE_COLOR = 0x06C1FA;
