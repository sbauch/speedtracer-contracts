...
contract LimeRockThemeRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0x013C4C;
    uint24 public constant KERB_COLOR = 0xEA1B2D;
    uint24 public constant ROAD_COLOR = 0xFFFFFF;
    uint24 public constant MIDLINE_COLOR = 0x6AA4B9;
