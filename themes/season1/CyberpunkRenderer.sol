...
contract CyberpunkRenderer is IThemeRenderer {
    bytes16 private constant SYMBOLS = "0123456789ABCDEF";

    uint24 public constant BACKGROUND_COLOR = 0x0F2041;
    uint24 public constant KERB_COLOR = 0x521D47;
    uint24 public constant ROAD_COLOR = 0xD56C8C;
    uint24 public constant MIDLINE_COLOR = 0xE883A0;
